...
/**
 * Verbosity of SDK logging, set via the SmartSpectraSDK `logLevel` option.
 * Levels are cumulative: a level shows its own messages plus everything
 * more severe.
 */
export declare const SmartSpectraLogLevel: {
    readonly kDebug:   0;
    readonly kInfo:    1;
    readonly kWarning: 2;
    readonly kError:   3;
...
export declare const ValidationCode: {
    ...
    /** @deprecated Use kFaceTooClose / kFaceTooFar instead. */
...
export interface SmartSpectraOptions {
    ...
    /**
     * Verbosity of SDK logging, applied when the session initializes.
     * Defaults to SmartSpectraLogLevel.kWarning (warnings and errors only).
     */
