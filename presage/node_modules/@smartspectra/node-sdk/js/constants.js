...
// Levels are cumulative: a level shows its own messages plus everything more
// severe. kDebug cannot restore debug-only statements compiled out of the
// release engine binary.
const SmartSpectraLogLevel = Object.freeze({
    kDebug:   0,
    kInfo:    1,
    kWarning: 2,  // the default
    kError:   3,
    kNone:    4,
});
